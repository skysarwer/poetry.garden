...
?>
<div id="signup-content" class="uswidecolumn">
...
function show_blog_form( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	echo '<p class="signup-info">Your address must be at least 4 characters, letters and numbers only. It cannot be changed, so choose carefully!</p>';
	}
	...
	<div id="privacy"><br/>
		<p class="privacy-intro" style="margin-bottom:0;">
			<?php _e( '<strong>Privacy:</strong>' ); ?>
			<?php _e( 'Do you want this site to be visible to search engines and the public listings on this site network?' ); ?>
			<br style="clear:both" />
...
function show_user_form( $user_name = '', $user_email = '', $errors = '' ) {
	...
	if ( $errmsg ) {
		...
		<p class="error"><?php echo $errmsg; ?></p>
	<?php } ?>
	<input name="user_email" type="email" id="user_email" value="<?php echo esc_attr( $user_email ); ?>" maxlength="200" /><br />
	<?php
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	echo '<h2>' . sprintf( __( 'Register a new site' ), get_network()->site_name ) . '</h2>';
	...
	<p>
		...
		printf(
			...
			__( 'Fill out the form below to register your own site on the poetry.garden domain.' ),
			$current_user->display_name
		);
		?>
	</p>
	<form id="setupform" method="post" action="/register-site">
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	<?php
		...
		printf( __( 'First, create an account.' ), get_network()->site_name );
	?>
	</h2>
	<form id="setupform" method="post" action="/register-site" novalidate="novalidate">
		...
		<?php } else { ?>
			...
			<label class="checkbox" for="signupblog"><?php _e( 'Register a site next' ); ?></label>
			<br />
			<input id="signupuser" type="radio" name="signup_for" value="user" <?php checked( $signup_for, 'user' ); ?> />
			<label class="checkbox" for="signupuser"><?php _e( 'Just register an account for now' ); ?></label>
		<?php } ?>
		</p>
